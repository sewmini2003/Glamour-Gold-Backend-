...
if (isset($_POST['update_product'])) {
    ...
    if ($_FILES['image']['error'] === 0) {
        ...
        $sqlGetImge = "SELECT imgURL from products WHERE proID = $proID";
        ...
        $sql = "UPDATE products SET name = '$productName', imgURL = '$new_img_name',
    description = '$description', price = '$price',  WHERE proID = '$proID'";
        ...
        $sql = "UPDATE products SET name = '$productName',
                description = '$description', price = '$price' WHERE proID = '$proID'";
    }
